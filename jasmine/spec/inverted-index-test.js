describe("Inverted Index", function() {
    ...
    describe('File loading test', function() {
        ...
        it('should throw an error when file cannot be opened', function() {
            expect(function() {
                myIndex.loadData('non_existent.json');
    ...
    describe('Search Index', function() {
        ...
        it("should ensure index returns the correct results when searched", function() {
            ...
            expect(myIndex.searchIndex('man')).toEqual([[1]]);
            expect(myIndex.searchIndex('fellowship')).toEqual([[1]]);
            expect(myIndex.searchIndex('Hole')).toEqual([[0]]);
        });
